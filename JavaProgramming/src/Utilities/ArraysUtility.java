...
public class ArraysUtility {
    ...
    //returns the max number for an int array
    public static int maxNumber(int[] array){
        Arrays.sort(array);
        return array[array.length-1];
    }

    //returns the max number for a double array
    public static double maxNumber(double[] array){
        Arrays.sort(array);
        return array[array.length-1];
    }

    //returns the min number for a int array
    public static int minNumber(int[] array){
        Arrays.sort(array);
        return array[0];
    }

    //returns the min number for a double array
    public static double minNumber(double[] array){
        Arrays.sort(array);
        return array[0];
    }

    //checks if the given integer is contained in the given array, returs boolean
    ...
    //checks if the given double is contained in the given array, returs boolean
    ...
    //checks if the given char is contained in the given array, returs boolean
